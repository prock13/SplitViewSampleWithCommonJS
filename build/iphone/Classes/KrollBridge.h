...
@interface SplitViewSampleWithCommonJSObject : KrollCoverageObject {
#else
@interface SplitViewSampleWithCommonJSObject : KrollObject {
#endif
@private
...
extern NSString * SplitViewSampleWithCommonJS$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	SplitViewSampleWithCommonJSObject *_splitviewsamplewithcommonjs;
	BOOL shutdown;
