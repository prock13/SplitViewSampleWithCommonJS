 ...
 * Copyright (c) 2009-2011 by SplitViewSampleWithCommonJS, Inc. All Rights Reserved.
...
//@interface SplitViewSampleWithCommonJSObject : NSObject
//@end

@interface SplitViewSampleWithCommonJSObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SplitViewSampleWithCommonJSObject class]])
		{
			for (NSString *key in [[(SplitViewSampleWithCommonJSObject*)o modules] allKeys])
			{
