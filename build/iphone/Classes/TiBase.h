...
// in simulator we redefine to format for SplitViewSampleWithCommonJS Developer console
...
{\
	NSString * exceptionName = [@"org.splitviewsamplewithcommonjs." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.splitviewsamplewithcommonjs";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISplitViewSampleWithCommonJSNativeItemNone = -1, 
	UISplitViewSampleWithCommonJSNativeItemSpinner = -2,
	UISplitViewSampleWithCommonJSNativeItemProgressBar = -3,
	
	UISplitViewSampleWithCommonJSNativeItemSlider = -4,
	UISplitViewSampleWithCommonJSNativeItemSwitch = -5,
	UISplitViewSampleWithCommonJSNativeItemMultiButton = -6,
	UISplitViewSampleWithCommonJSNativeItemSegmented = -7,
	
	UISplitViewSampleWithCommonJSNativeItemTextView = -8,
	UISplitViewSampleWithCommonJSNativeItemTextField = -9,
	UISplitViewSampleWithCommonJSNativeItemSearchBar = -10,
	
	UISplitViewSampleWithCommonJSNativeItemPicker = -11,
	UISplitViewSampleWithCommonJSNativeItemDatePicker = -12,
	
	UISplitViewSampleWithCommonJSNativeItemInfoLight = -13,
	UISplitViewSampleWithCommonJSNativeItemInfoDark = -14,
	
	UISplitViewSampleWithCommonJSNativeItemDisclosure = -15,
	
	UISplitViewSampleWithCommonJSNativeItemContactAdd = -16
};
